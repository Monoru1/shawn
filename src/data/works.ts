...
export const works: Work[] = [
  ...
  {
    slug: 'colours-of-independence',
    medium: 'photo',
    year: '2024',
    order: 3,
    title: { fr: 'Colours of Independence', en: 'Colours of Independence' },
    category: { fr: 'Campagne de mode', en: 'Fashion campaign' },
    role: { fr: 'Photographie', en: 'Photography' },
    location: { fr: 'Sénégal', en: 'Senegal' },
    statement: {
      fr: 'Une campagne Daily Paper × Converse photographiée au Sénégal, où la mode s’inscrit dans un paysage, une communauté et une histoire partagée.',
      en: 'A Daily Paper × Converse campaign photographed in Senegal, where fashion belongs to a landscape, a community and a shared history.',
    },
    body: [
      {
        fr: 'Colours of Independence accompagne la collaboration entre Daily Paper et Converse. La série s’ancre au Sénégal et fait dialoguer vêtements, corps et territoire plutôt que de les isoler dans un décor de studio.',
        en: 'Colours of Independence accompanies the collaboration between Daily Paper and Converse. The series is rooted in Senegal, bringing garments, bodies and territory together rather than isolating them in a studio set.',
      },
      {
        fr: 'Les couleurs pan-africaines traversent les silhouettes et les détails des chaussures. Shawn compose des images collectives comme des scènes, avec le paysage comme une présence à part entière.',
        en: 'Pan-African colours run through the silhouettes and shoe details. Shawn composes collective images as scenes, with the landscape as a presence in its own right.',
      },
    ],
    credits: [
      { label: { fr: 'Photographie', en: 'Photography' }, value: 'Shawn N. Hounkpatin' },
      { label: { fr: 'Campagne', en: 'Campaign' }, value: 'Daily Paper × Converse' },
      { label: { fr: 'Lieu', en: 'Location' }, value: 'Sénégal / Senegal' },
      { label: { fr: 'Année', en: 'Year' }, value: '2024' },
    ],
    partners: ['Daily Paper', 'Converse'],
    cover: media.dailyPaperConverse.cover,
    gallery: media.dailyPaperConverse.gallery,
    ratio: 'wide',
  },
  {
